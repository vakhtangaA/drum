          ...
          <a href="#" onClick={playW}>
            <div className="drum-pad" id="acoustic-bass">
              ...
              <audio
                className="clip"
                id="W"
                src="https://sampleswap.org/samples-ghost/DRUMS%20(FULL%20KITS)/STYLE%20KITS%20(Hip%20Hop,%20Etc)/Aggressive%20Electronic%20Kit/89[kb]newjr-16.wav.mp3"
                // type="audio/mp3"
              ></audio>
            </div>
          </a>
          <a href="#" onClick={playE}>
            <div className="drum-pad" id="distortobass">
              ...
              <audio
                className="clip"
                id="E"
                src="https://sampleswap.org/samples-ghost/INSTRUMENTS%20(MULTISAMPLED)/BASS/7rystan%20Trap%20Bass/795[kb]7rystan-trap_bass_02.wav.mp3"
              ></audio>
            </div>
          </a>
          ...
          <a href="#" onClick={playS}>
            <div className="drum-pad" id="bass-bombdive">
              ...
              <audio
                className="clip"
                id="S"
                src="https://sampleswap.org/samples-ghost/LOOPING%20AMBIENCE/837[kb]074_heartbeat-noise-machine.wav.mp3"
              ></audio>
            </div>
          </a>
          <a href="#" onClick={playD}>
            <div className="drum-pad" id="bass-poweron">
              ...
              <audio
                className="clip"
                id="D"
                src="https://sampleswap.org/samples-ghost/LOOPING%20AMBIENCE/746[kb]083_pretty-noise-rhythm.wav.mp3"
              ></audio>
            </div>
          </a>
          <a href="#" onClick={playZ}>
            <div className="drum-pad" id="bass-synth">
              ...
              <audio
                className="clip"
                id="Z"
                src="https://sampleswap.org/samples-ghost/SOUND%20EFFECTS%20and%20NOISES/Kung%20Fu%20Construction%20Kit/672[kb]temple-bell-BEGIN-FIGHT.wav.mp3"
              ></audio>
            </div>
          </a>
          <a href="#" onClick={playX}>
            <div className="drum-pad" id="bow-bass-echo">
              ...
              <audio
                className="clip"
                id="X"
                src="https://sampleswap.org/samples-ghost/SOUND%20EFFECTS%20and%20NOISES/Computery%20or%20Science%20Fiction/296[kb]bloop-bloop-bend-fx.wav.mp3"
              ></audio>
            </div>
          </a>
          <a href="#" onClick={playC}>
            <div className="drum-pad" id="fatreverb">
              ...
              <audio
                className="clip"
                id="C"
                src="https://sampleswap.org/samples-ghost/SOUND%20EFFECTS%20and%20NOISES/Kung%20Fu%20Construction%20Kit/79[kb]right-cross.wav.mp3"
              ></audio>
            </div>
          </a>
